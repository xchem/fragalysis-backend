...
class NetworkFunctionsTestCase(SimpleTestCase):
    ...
    def test_order_structures(self):
        test_json = '{"DEPTH": {"TYPEONE": {"ONE": {"smiles": "SMILES", "annotation": "ADD_DEC"}}}, "-1": {"ADDITION": {"O": {"smiles": [], "annotation": "ADD_MISS"}, "N": {"smiles": [], "annotation": "ADD_MISS"}, "E": {"smiles": [], "annotation": "ADD_MISS"}, "_": {"smiles": [], "annotation": "ADD_MISS"}, "M": {"smiles": [], "annotation": "ADD_MISS"}}, "DELETION": {"T": {"smiles": [], "annotation": "DEL_MISS"}, "W": {"smiles": [], "annotation": "DEL_MISS"}, "O": {"smiles": [], "annotation": "DEL_MISS"}, "_": {"smiles": [], "annotation": "DEL_MISS"}, "M": {"smiles": [], "annotation": "DEL_MISS"}, "E": {"smiles": [], "annotation": "DEL_MISS"}}, "LINKER": {"T": {"smiles": [], "annotation": "LINK_MISS"}, "H": {"smiles": [], "annotation": "LINK_MISS"}, "R": {"smiles": [], "annotation": "LINK_MISS"}, "E": {"smiles": [], "annotation": "LINK_MISS"}, "_": {"smiles": [], "annotation": "LINK_MISS"}, "M": {"smiles": [], "annotation": "LINK_MISS"}}}}'
