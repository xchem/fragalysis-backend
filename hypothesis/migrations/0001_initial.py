    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('AD', 'Addition'), ('DE', 'Deletion'), ('LI', 'Linker'), ('RI', 'Ring')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hypothesis.vector')),
            ],
        ),
        migrations.CreateModel(
            name='TargetResidue',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_observation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='viewer.siteobservation')),
                ('targ_res', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hypothesis.targetresidue')),
            ],
        ),
        migrations.CreateModel(
            name='Interaction',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interaction_version', models.CharField(choices=[('DE', 'Default'), ('PR', 'Proasis')], default='DE', max_length=2)),
                ('interaction_type', models.CharField(choices=[('UK', 'Unkwnon'), ('HB', 'H-bond'), ('CP', 'Cation Pi'), ('HA', 'Halogen'), ('VD', 'Van der Waals'), ('CH', 'Charge'), ('WB', 'Weak H-bond'), ('CD', 'Cation Dipole'), ('HP', 'H-bond donor Pi'), ('DI', 'Dipolar'), ('PP', 'Pi Pi'), ('PA', 'Poor angle'), ('UF', 'Unfavourable')], default='UK', max_length=2)),
                ('distance', models.FloatField(null=True)),
                ('score', models.FloatField(null=True)),
                ('prot_smarts', models.TextField(null=True)),
                ('mol_smarts', models.TextField(null=True)),
                ('interaction_point', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hypothesis.interactionpoint')),
            ],
        ),
