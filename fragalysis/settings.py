...
# A service that provides target access strings based on user
# that provides /ping, /version and /target-access/{username} endpoints.
# This is typically a kubernetes service like "auth.ta-authenticator.svc"
TA_AUTH_SERVICE: str = os.environ.get("TA_AUTH_SERVICE", "").lower()
# The authenticator query key.
# Typically a UUID4 generated by the authenticator deployment.
TA_AUTH_QUERY_KEY: str = os.environ.get("TA_AUTH_QUERY_KEY", "")
