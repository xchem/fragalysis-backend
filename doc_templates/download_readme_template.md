...
- `[target-name_crystal-name]_sigmaa.ccp4` --- 2mFo-DFc sigmaA-weighted map cut to around 12 Ang around the ligand - Estimate of the true electron density from diffraction data and atomic model
- `[target-name_crystal-name]_diff.ccp4` --- mFo-DFc sigmaA-weighted difference map cut to around 12 Ang around the ligand - Negative density indicates model without supporting density, positive density indicates unmodelled features
...
- `[target-name_crystal-name]_sigmaa_crystallographic.ccp4` --- 2mFo-DFc sigmaA-weighted map cut to around 12 Ang around the ligand - Estimate of the true electron density from diffraction data and atomic model
- `[target-name_crystal-name]_diff_crystallographic.ccp4` --- mFo-DFc sigmaA-weighted difference map cut to around 12 Ang around the ligand - Negative density indicates model without supporting density, positive density indicates unmodelled features
