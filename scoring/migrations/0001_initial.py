    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_observation', models.ManyToManyField(related_name='site_observation_groups', to='viewer.SiteObservation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_type', models.CharField(choices=[('DE', 'Default'), ('AU', 'Docking'), ('IT', 'Interaction fit'), ('DF', 'Density Fit')], default='DE', max_length=2)),
                ('score', models.FloatField(null=True)),
                ('site_observation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='viewer.siteobservation')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choice_type', models.CharField(choices=[('DE', 'Default'), ('PR', 'Price'), ('TO', 'Toxic')], default='DE', max_length=2)),
                ('score', models.FloatField(null=True)),
