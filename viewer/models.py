...
class Target(models.Model):
    ...
    uniprot_id = models.CharField(max_length=100, null=True,
                                  help_text='the uniprot ID id for the target. Is a unique key')
...
class ComputedMolecule(models.Model):
    ...
    """
    compound = models.ForeignKey(Compound, on_delete=models.CASCADE)
    sdf_info = models.TextField(null=False, help_text="The 3D coordinates for the molecule")
...
class Squonk2Project(models.Model):
    ...
    name = models.TextField(null=False, help_text="The name of the Squonk2 Project UUID (obtained form the AS)")
