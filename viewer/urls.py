...
urlpatterns = [
    ...
    url(
        ...
        views.img_from_mol_pk,
        name="img_from_mol_pk",
    ),
    url(
        r"^img_from_cmpd_pk/(?P<pk>[0-9]+)/$",
        views.img_from_cmpd_pk,
        name="img_from_cmpd_pk",
    ),
    ...
    url(
        r"^get_vects_from_pk/(?P<pk>[0-9]+)/",
        views.get_vects_from_pk,
        name="get_vects_from_pk",
    ),
    url(
        r"^get_graph_from_pk/(?P<pk>[0-9]+)/",
