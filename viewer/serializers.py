...
class PanddaEventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PanddaEvent
        fields = ('xtal','event','pandda_site','target_id','pdb_info','mtz_info','map_info','lig_id',
...
class PanddaSiteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PanddaSite
        fields = ('site_id','pandda_run','pandda_version','target_id','site_align_com_x','site_align_com_y','site_align_com_z',
